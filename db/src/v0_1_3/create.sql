...
-- Users Table
CREATE TABLE IF NOT EXISTS Users (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT NOT NULL UNIQUE, email TEXT, user_type BLOB NOT NULL, password TEXT NOT NULL, created_at TEXT NOT NULL, last_login TEXT NOT NULL);
